...
const financeNav: NavItem[] = [
  ...
  { label: 'Subscriptions', path: '/subscriptions',  icon: <MdCardMembership size={18} /> },
]
  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        <div>
          <p style={{ color: '#fff', fontWeight: 600, fontSize: 14, lineHeight: 1, margin: 0 }}>
            FitZone
          </p>
          <p style={{ color: 'var(--color-text-muted)', fontSize: 11, marginTop: 3, margin: 0 }}>
            Management System
          </p>
        </div>
      </div>
      ...
      <div style={{ borderTop: '1px solid var(--color-border)', padding: 10 }}>
        <NavItemLink item={{ label: 'Settings', path: '/settings', icon: <MdSettings size={18} /> }} />
      </div>
    </aside>
  )
}
